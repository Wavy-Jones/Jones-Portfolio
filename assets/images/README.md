...
- Include browser chrome for web apps (makes them look more professional)
- Consider using tools like:
  - [Screely](https://screely.com/) - Add browser mockups
  - [Shots.so](https://shots.so/) - Beautiful browser mockups
  - Windows Snipping Tool (Win + Shift + S)
  - For API diagram: [Excalidraw](https://excalidraw.com/) or draw.io

## Placeholder

Until you add real images, the gradient background will show. The hover overlay will still work!
